...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelloBooks = React.createClass({
	    displayName: 'HelloBooks',
	    ...
	    loadBooksFromServer: function () {
	        $.ajax({
	            ...
	            success: function (data) {
	                this.setState({ data: data[0].title });
	            }.bind(this)
	        });
	    },
	...
	ReactDOM.render(React.createElement(HelloBooks, { url: '/api/', pollInterval: 1000 }), document.getElementById('container'));
